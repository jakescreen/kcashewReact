...
export default class TwitchArticles extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                {yeet}
                <iframe id={"embed_" + this.state.channel1}  src={"https://player.twitch.tv/?muted=true&channel=" + this.state.channel1} className="stream" allowFullScreen={true}></iframe>
                
                <iframe id={"embed_" + this.state.channel2}  src={"https://player.twitch.tv/?muted=true&channel=" + this.state.channel2} className="stream" allowFullScreen={true}></iframe>
            </div>
